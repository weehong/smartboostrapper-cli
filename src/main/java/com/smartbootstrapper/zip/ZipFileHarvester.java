...
/**
 * Harvests files from ZIP-based commit snapshots.
 */
public class ZipFileHarvester {

    private static final Logger logger = LoggerFactory.getLogger(ZipFileHarvester.class);

    private final ZipRepositoryService repositoryService;
    private BiConsumer<String, Boolean> progressCallback;

    public ZipFileHarvester(ZipRepositoryService repositoryService) {
    ...
    /**
     * Harvests all files specified in the manifest from ZIP archives.
     *
